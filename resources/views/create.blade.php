        ...
        <div class="container">
            <div class="card mt-5">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="/add_book/store">
                        ...
                        <div class="form-group">
                            <label>Author</label>
                            <input type="text" name="author" class="form-control" required="required" placeholder="Author ..">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="1" name="pages" class="form-control" placeholder="Number of Pages..">
